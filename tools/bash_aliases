...
function multitail-prod {
    multitail -s 2  \
        ...
        -CS apache \
        -l 'ssh bitnami@app20.prod.c2gops.com "tail -f stack/apache2/logs/access_log"' \
        -l 'ssh bitnami@app21.prod.c2gops.com "tail -f stack/apache2/logs/access_log"' \
        -l 'ssh bitnami@app22.prod.c2gops.com "tail -f stack/apache2/logs/access_log"' \
        -c- \
        -l 'ssh ubuntu@util1.prod.c2gops.com "tail -f /var/log/celery/*.log"' \
        -CS apache_error \
        -l 'ssh bitnami@app20.prod.c2gops.com "tail -f stack/apache2/logs/error_log"' \
        -l 'ssh bitnami@app21.prod.c2gops.com "tail -f stack/apache2/logs/error_log"' \
        -l 'ssh bitnami@app22.prod.c2gops.com "tail -f stack/apache2/logs/error_log"' \
        -c- \
