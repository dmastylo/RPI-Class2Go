...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Course.student_group'
        db.delete_column(u'c2g_courses', 'student_group_id')

        # Deleting field 'Course.instructor_group'
        db.delete_column(u'c2g_courses', 'instructor_group_id')

        # Deleting field 'Course.tas_group'
        db.delete_column(u'c2g_courses', 'tas_group_id')

        # Deleting field 'Course.readonly_tas_group'
        db.delete_column(u'c2g_courses', 'readonly_tas_group_id')
    ...
    models = {
        ...
        'c2g.course': {
            ...
            'instructor_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'related_name': "'instructor_group'", 'to': "orm['auth.Group']"}),
            ...
            'readonly_tas_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'related_name': "'readonly_tas_group'", 'to': "orm['auth.Group']"}),
            'staff_emails': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'student_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'related_name': "'student_group'", 'to': "orm['auth.Group']"}),
            'tas_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'related_name': "'tas_group'", 'to': "orm['auth.Group']"}),
