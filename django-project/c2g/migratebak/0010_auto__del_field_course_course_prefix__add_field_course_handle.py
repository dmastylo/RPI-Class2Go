...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.handle'
        db.add_column(u'c2g_courses', 'handle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Course.handle'
        db.delete_column(u'c2g_courses', 'handle')
