...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.handle'
        db.add_column(u'c2g_exercises', 'handle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Video.handle'
        db.add_column(u'c2g_videos', 'handle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.handle'
        db.delete_column(u'c2g_exercises', 'handle')

        # Deleting field 'Video.handle'
        db.delete_column(u'c2g_videos', 'handle')
