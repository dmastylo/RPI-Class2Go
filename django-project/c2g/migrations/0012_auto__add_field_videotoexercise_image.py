...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoToExercise.image'
        db.add_column(u'c2g_video_to_exercise', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.VideoToExercise'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoToExercise.image'
        db.delete_column(u'c2g_video_to_exercise', 'image_id')
