...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.is_instructor'
        db.delete_column(u'c2g_user_profiles', 'is_instructor')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.is_instructor'
        db.add_column(u'c2g_user_profiles', 'is_instructor',
                      self.gf('django.db.models.fields.IntegerField')(default=False, blank=True),
                      keep_default=False)
