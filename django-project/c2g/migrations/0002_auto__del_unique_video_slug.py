...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Video', fields ['slug']
        db.delete_unique(u'c2g_videos', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'Video', fields ['slug']
        db.create_unique(u'c2g_videos', ['slug'])
