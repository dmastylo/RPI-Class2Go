...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.feature_settings'
        db.delete_column(u'c2g_courses', 'feature_settings')
        ...
        # Adding field 'ProblemSet.mode'
        db.add_column(u'c2g_problem_sets', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.image'
        db.add_column(u'c2g_problem_sets', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.ProblemSet']),
                      keep_default=False)

        # Adding field 'ProblemSet.live_datetime'
        db.add_column(u'c2g_problem_sets', 'live_datetime',
        ...
        # Adding field 'Problem.mode'
        db.add_column(u'c2g_problems', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Problem.image'
        db.add_column(u'c2g_problems', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.Problem']),
                      keep_default=False)

        # Adding field 'Problem.live_datetime'
        db.add_column(u'c2g_problems', 'live_datetime',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AdditionalPage.mode'
        db.add_column(u'c2g_additional_pages', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AdditionalPage.image'
        db.add_column(u'c2g_additional_pages', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.AdditionalPage']),
                      keep_default=False)

        # Adding field 'AdditionalPage.live_datetime'
        db.add_column(u'c2g_additional_pages', 'live_datetime',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.feature_settings'
        db.add_column(u'c2g_courses', 'feature_settings',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        ...
        # Deleting field 'ProblemSet.mode'
        db.delete_column(u'c2g_problem_sets', 'mode')

        # Deleting field 'ProblemSet.image'
        db.delete_column(u'c2g_problem_sets', 'image_id')

        # Deleting field 'ProblemSet.live_datetime'
        db.delete_column(u'c2g_problem_sets', 'live_datetime')


        # Changing field 'VideoTopic.live_datetime'
        db.alter_column(u'c2g_video_topics', 'live_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'Problem.mode'
        db.delete_column(u'c2g_problems', 'mode')

        # Deleting field 'Problem.image'
        db.delete_column(u'c2g_problems', 'image_id')

        # Deleting field 'Problem.live_datetime'
        db.delete_column(u'c2g_problems', 'live_datetime')


        # Changing field 'Video.live_datetime'
        db.alter_column(u'c2g_videos', 'live_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'AdditionalPage.mode'
        db.delete_column(u'c2g_additional_pages', 'mode')

        # Deleting field 'AdditionalPage.image'
        db.delete_column(u'c2g_additional_pages', 'image_id')

        # Deleting field 'AdditionalPage.live_datetime'
        db.delete_column(u'c2g_additional_pages', 'live_datetime')
    ...
    models = {
        ...
        'c2g.additionalpage': {
            ...
            'live_datetime': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
