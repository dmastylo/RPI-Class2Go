...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProblemActivity.problemset_to_exercise'
        db.add_column(u'c2g_problem_activity', 'problemset_to_exercise',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProblemActivity.problemset_to_exercise'
        db.delete_column(u'c2g_problem_activity', 'problemset_to_exercise_id')
