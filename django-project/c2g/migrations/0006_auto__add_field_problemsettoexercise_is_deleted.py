...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemSetToExercise.is_deleted'
        db.add_column(u'c2g_problemset_to_exercise', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemSetToExercise.is_deleted'
        db.delete_column(u'c2g_problemset_to_exercise', 'is_deleted')
