...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProblemActivity.video_to_exercise'
        db.add_column(u'c2g_problem_activity', 'video_to_exercise',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.VideoToExercise'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProblemActivity.video_to_exercise'
        db.delete_column(u'c2g_problem_activity', 'video_to_exercise_id')
