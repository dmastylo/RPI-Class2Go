...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.is_instructor'
        db.alter_column(u'c2g_user_profiles', 'is_instructor', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.is_instructor'
        db.alter_column(u'c2g_user_profiles', 'is_instructor', self.gf('django.db.models.fields.IntegerField')(null=True))
