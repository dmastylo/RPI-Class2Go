...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'c2g_videos', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(0, 0)),
                      keep_default=False)


        # Changing field 'Video.url'
        db.alter_column(u'c2g_videos', 'url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Video.start_time'
        db.delete_column(u'c2g_videos', 'start_time')


        # Changing field 'Video.url'
        db.alter_column(u'c2g_videos', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
