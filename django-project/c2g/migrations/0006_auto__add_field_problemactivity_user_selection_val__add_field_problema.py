...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemActivity.user_selection_val'
        db.add_column(u'c2g_problem_activity', 'user_selection_val',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemActivity.user_choices'
        db.add_column(u'c2g_problem_activity', 'user_choices',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemActivity.user_selection_val'
        db.delete_column(u'c2g_problem_activity', 'user_selection_val')

        # Deleting field 'ProblemActivity.user_choices'
        db.delete_column(u'c2g_problem_activity', 'user_choices')
    ...
    models = {
        ...
        'c2g.problemactivity': {
            ...
            'user_choices': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user_selection_val': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
