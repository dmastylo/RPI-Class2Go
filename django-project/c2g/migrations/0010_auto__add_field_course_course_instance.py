...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.course_instance'
        db.add_column(u'c2g_courses', 'course_instance',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.course_instance'
        db.delete_column(u'c2g_courses', 'course_instance')
    ...
    models = {
        ...
        u'c2g.course': {
            ...
            'course_instance': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'db_index': 'True'}),
