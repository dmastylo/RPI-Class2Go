...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProblemActivity.topic_id'
        db.delete_column(u'c2g_problem_activity', 'topic_id_id')


    def backwards(self, orm):
        # Adding field 'ProblemActivity.topic_id'
        db.add_column(u'c2g_problem_activity', 'topic_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['c2g.VideoTopic']),
                      keep_default=False)
