...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.access_id'
        db.delete_column(u'c2g_videos', 'access_id')

        # Adding field 'Video.index'
        db.add_column(u'c2g_videos', 'index',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.slug'
        db.add_column(u'c2g_videos', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'VideoTopic.index'
        db.add_column(u'c2g_video_topics', 'index',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Video.access_id'
        db.add_column(u'c2g_videos', 'access_id',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Video.index'
        db.delete_column(u'c2g_videos', 'index')

        # Deleting field 'Video.slug'
        db.delete_column(u'c2g_videos', 'slug')

        # Deleting field 'VideoTopic.index'
        db.delete_column(u'c2g_video_topics', 'index')
