...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProblemActivity.problem_set'
        db.delete_column(u'c2g_problem_activity', 'problem_set_id')

        # Adding field 'ProblemActivity.time_created'
        db.add_column(u'c2g_problem_activity', 'time_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 23, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ProblemActivity.last_updated'
        db.add_column(u'c2g_problem_activity', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2012, 7, 23, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Problem.problem_number'
        db.delete_column(u'c2g_problems', 'problem_number')

        # Deleting field 'Problem.problem_set'
        db.delete_column(u'c2g_problems', 'problem_set_id')

        # Adding field 'Problem.exercise'
        db.add_column(u'c2g_problems', 'exercise',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['c2g.Exercise']),
                      keep_default=False)

        # Adding field 'Problem.number'
        db.add_column(u'c2g_problems', 'number',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ProblemActivity.problem_set'
        db.add_column(u'c2g_problem_activity', 'problem_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ProblemSet'], null=True),
                      keep_default=False)

        # Deleting field 'ProblemActivity.time_created'
        db.delete_column(u'c2g_problem_activity', 'time_created')

        # Deleting field 'ProblemActivity.last_updated'
        db.delete_column(u'c2g_problem_activity', 'last_updated')

        # Adding field 'Problem.problem_number'
        db.add_column(u'c2g_problems', 'problem_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.problem_set'
        db.add_column(u'c2g_problems', 'problem_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['c2g.ProblemSet']),
                      keep_default=False)

        # Deleting field 'Problem.exercise'
        db.delete_column(u'c2g_problems', 'exercise_id')

        # Deleting field 'Problem.number'
        db.delete_column(u'c2g_problems', 'number')
