...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'c2g_videos', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.duration'
        raise RuntimeError("Cannot reverse this migration. 'Video.duration' and its values cannot be restored.")
