...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProblemSet.section'
        db.alter_column(u'c2g_problem_sets', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['c2g.ContentSection']))

        # Changing field 'ProblemSet.resubmission_penalty'
        db.alter_column(u'c2g_problem_sets', 'resubmission_penalty', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ProblemSet.partial_credit_deadline'
        db.alter_column(u'c2g_problem_sets', 'partial_credit_deadline', self.gf('django.db.models.fields.DateTimeField')(default=0))

        # Changing field 'ProblemSet.grace_period'
        db.alter_column(u'c2g_problem_sets', 'grace_period', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 17, 0, 0)))

        # Changing field 'ProblemSet.late_penalty'
        db.alter_column(u'c2g_problem_sets', 'late_penalty', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ProblemSet.submissions_permitted'
        db.alter_column(u'c2g_problem_sets', 'submissions_permitted', self.gf('django.db.models.fields.IntegerField')(default=3))

    def backwards(self, orm):

        # Changing field 'ProblemSet.section'
        db.alter_column(u'c2g_problem_sets', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ContentSection'], null=True))

        # Changing field 'ProblemSet.resubmission_penalty'
        db.alter_column(u'c2g_problem_sets', 'resubmission_penalty', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProblemSet.partial_credit_deadline'
        db.alter_column(u'c2g_problem_sets', 'partial_credit_deadline', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProblemSet.grace_period'
        db.alter_column(u'c2g_problem_sets', 'grace_period', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProblemSet.late_penalty'
        db.alter_column(u'c2g_problem_sets', 'late_penalty', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProblemSet.submissions_permitted'
        db.alter_column(u'c2g_problem_sets', 'submissions_permitted', self.gf('django.db.models.fields.IntegerField')(null=True))
