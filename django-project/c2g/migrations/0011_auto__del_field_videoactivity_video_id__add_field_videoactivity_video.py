...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoActivity.video_id'
        db.delete_column(u'c2g_video_activity', 'video_id_id')

        # Adding field 'VideoActivity.video'
        db.add_column(u'c2g_video_activity', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=26, to=orm['c2g.Video']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoActivity.video_id'
        db.add_column(u'c2g_video_activity', 'video_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Video'], null=True),
                      keep_default=False)

        # Deleting field 'VideoActivity.video'
        db.delete_column(u'c2g_video_activity', 'video_id')
    ...
    models = {
        ...
        'c2g.videoactivity': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c2g.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_seconds': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'default': '26', 'to': "orm['c2g.Video']"})
        },
        'c2g.videoannotation': {
