...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemSet.question_count'
        db.add_column(u'c2g_problem_sets', 'question_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemSet.question_count'
        db.delete_column(u'c2g_problem_sets', 'question_count')
