...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Course', fields ['handle']
        db.delete_unique(u'c2g_courses', ['handle'])

        # Adding field 'Video.mode'
        db.add_column(u'c2g_videos', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Video.image'
        db.add_column(u'c2g_videos', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.Video']),
                      keep_default=False)
        ...
        db.add_column(u'c2g_courses', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.Course']),
                      keep_default=False)

        # Adding field 'Course.live_datetime'
        db.add_column(u'c2g_courses', 'live_datetime',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'c2g_videos', 'mode')

        # Deleting field 'Video.image'
        db.delete_column(u'c2g_videos', 'image_id')

        # Deleting field 'Course.mode'
        db.delete_column(u'c2g_courses', 'mode')

        # Deleting field 'Course.image'
        db.delete_column(u'c2g_courses', 'image_id')

        # Deleting field 'Course.live_datetime'
        db.delete_column(u'c2g_courses', 'live_datetime')

        # Adding unique constraint on 'Course', fields ['handle']
        db.create_unique(u'c2g_courses', ['handle'])
