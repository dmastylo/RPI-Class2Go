...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalPage.index'
        db.add_column(u'c2g_additional_pages', 'index',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalPage.index'
        db.delete_column(u'c2g_additional_pages', 'index')
