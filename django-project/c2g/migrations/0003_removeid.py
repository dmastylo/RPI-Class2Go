...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Assignment.category_id'
        db.delete_column(u'c2g_assignments', 'category_id_id')

        # Adding field 'Assignment.category'
        db.add_column(u'c2g_assignments', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['c2g.AssignmentCategory']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Assignment.category_id'
        raise RuntimeError("Cannot reverse this migration. 'Assignment.category_id' and its values cannot be restored.")
        # Deleting field 'Assignment.category'
        db.delete_column(u'c2g_assignments', 'category_id')
