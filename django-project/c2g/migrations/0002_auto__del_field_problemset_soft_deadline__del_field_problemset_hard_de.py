...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProblemSet.soft_deadline'
        db.delete_column(u'c2g_problem_sets', 'soft_deadline')

        # Deleting field 'ProblemSet.hard_deadline'
        db.delete_column(u'c2g_problem_sets', 'hard_deadline')

        # Adding field 'ProblemSet.live_date'
        db.add_column(u'c2g_problem_sets', 'live_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.due_date'
        db.add_column(u'c2g_problem_sets', 'due_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.grace_period'
        db.add_column(u'c2g_problem_sets', 'grace_period',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.partial_credit_deadline'
        db.add_column(u'c2g_problem_sets', 'partial_credit_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.penalty_preference'
        db.add_column(u'c2g_problem_sets', 'penalty_preference',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2012, 7, 30, 0, 0), max_length=255),
                      keep_default=False)

        # Adding field 'ProblemSet.late_penalty'
        db.add_column(u'c2g_problem_sets', 'late_penalty',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.submissions_permitted'
        db.add_column(u'c2g_problem_sets', 'submissions_permitted',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.resubmission_penalty'
        db.add_column(u'c2g_problem_sets', 'resubmission_penalty',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.randomize'
        db.add_column(u'c2g_problem_sets', 'randomize',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProblemSet.soft_deadline'
        db.add_column(u'c2g_problem_sets', 'soft_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSet.hard_deadline'
        db.add_column(u'c2g_problem_sets', 'hard_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProblemSet.live_date'
        db.delete_column(u'c2g_problem_sets', 'live_date')

        # Deleting field 'ProblemSet.due_date'
        db.delete_column(u'c2g_problem_sets', 'due_date')

        # Deleting field 'ProblemSet.grace_period'
        db.delete_column(u'c2g_problem_sets', 'grace_period')

        # Deleting field 'ProblemSet.partial_credit_deadline'
        db.delete_column(u'c2g_problem_sets', 'partial_credit_deadline')

        # Deleting field 'ProblemSet.penalty_preference'
        db.delete_column(u'c2g_problem_sets', 'penalty_preference')

        # Deleting field 'ProblemSet.late_penalty'
        db.delete_column(u'c2g_problem_sets', 'late_penalty')

        # Deleting field 'ProblemSet.submissions_permitted'
        db.delete_column(u'c2g_problem_sets', 'submissions_permitted')

        # Deleting field 'ProblemSet.resubmission_penalty'
        db.delete_column(u'c2g_problem_sets', 'resubmission_penalty')

        # Deleting field 'ProblemSet.randomize'
        db.delete_column(u'c2g_problem_sets', 'randomize')
    ...
    models = {
        ...
        'c2g.problemset': {
            ...
            'live_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'live_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'mode': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
