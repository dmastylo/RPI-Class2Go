...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProblemActivity.exercise'
        db.delete_column(u'c2g_problem_activity', 'exercise_id')

        # Adding field 'ProblemActivity.exercise_relationship'
        db.add_column(u'c2g_problem_activity', 'exercise_relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ProblemSetToExercise'], null=True),
                      keep_default=False)

        # Deleting field 'ProblemSet.penalty_preference'
        db.delete_column(u'c2g_problem_sets', 'penalty_preference')

        # Adding field 'ProblemSet.assessment_type'
        db.add_column(u'c2g_problem_sets', 'assessment_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProblemActivity.exercise'
        db.add_column(u'c2g_problem_activity', 'exercise',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Exercise'], null=True),
                      keep_default=False)

        # Deleting field 'ProblemActivity.exercise_relationship'
        db.delete_column(u'c2g_problem_activity', 'exercise_relationship_id')
        ...
        # Deleting field 'ProblemSet.assessment_type'
        db.delete_column(u'c2g_problem_sets', 'assessment_type')
    ...
    models = {
        ...
        'c2g.problemactivity': {
            ...
            'exercise_relationship': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c2g.ProblemSetToExercise']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
