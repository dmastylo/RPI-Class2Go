...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.problemSet'
        db.delete_column(u'c2g_exercises', 'problemSet_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Exercise.problemSet'
        db.add_column(u'c2g_exercises', 'problemSet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['c2g.ProblemSet']),
                      keep_default=False)
