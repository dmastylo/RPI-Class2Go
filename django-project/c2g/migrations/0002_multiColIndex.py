...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index(u'c2g_assignment_submissions', ['owner_id', 'assignment_id'])
        db.create_index(u'c2g_assignment_grades', ['user_id', 'assignment_id'])
        db.create_index(u'c2g_course_analytics', ['user_id', 'course_id'])
        db.create_index(u'c2g_files', ['owner_id', 'course_id'])
        db.create_index(u'c2g_officehours', ['owner_id', 'course_id'])
        db.create_index(u'c2g_roles', ['course_id', 'title'])
        db.create_index(u'c2g_user_course_data', ['user_id', 'course_id'])
        db.create_index(u'c2g_video_quiz_submissions', ['owner_id', 'question_id'])
        db.create_index(u'c2g_video_annotations', ['owner_id', 'video_id'])

    def backwards(self, orm):
        db.delete_index(u'c2g_assignment_submissions', ['owner_id', 'assignment_id'])
        db.delete_index(u'c2g_assignment_grades', ['user_id', 'assignment_id'])
        db.delete_index(u'c2g_course_analytics', ['user_id', 'course_id'])
        db.delete_index(u'c2g_files', ['owner_id', 'course_id'])
        db.delete_index(u'c2g_officehours', ['owner_id', 'course_id'])
        db.delete_index(u'c2g_roles', ['course_id', 'title'])
        db.delete_index(u'c2g_user_course_data', ['user_id', 'course_id'])
        db.delete_index(u'c2g_video_quiz_submissions', ['owner_id', 'question_id'])
        db.delete_index(u'c2g_video_annotations', ['owner_id', 'video_id'])
    ...
    models = {
        ...
        'c2g.additionalpage': {
            'Meta': {'object_name': 'AdditionalPage', 'db_table': "u'c2g_c2g_additional_pages'"},
