...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'c2g_courses', 'code')

        # Deleting field 'Course.membership_control'
        db.delete_column(u'c2g_courses', 'membership_control')

        # Deleting field 'Course.meeting_info'
        db.delete_column(u'c2g_courses', 'meeting_info')

        # Deleting field 'Course.listing_description'
        db.delete_column(u'c2g_courses', 'listing_description')

        # Deleting field 'Course.mode'
        db.delete_column(u'c2g_courses', 'mode')

        # Deleting field 'Course.join_password'
        db.delete_column(u'c2g_courses', 'join_password')

        # Deleting field 'Course.staff_emails'
        db.delete_column(u'c2g_courses', 'staff_emails')

        # Adding field 'Course.syllabus'
        db.add_column(u'c2g_courses', 'syllabus',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'c2g_courses', 'code',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.membership_control'
        db.add_column(u'c2g_courses', 'membership_control',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.meeting_info'
        db.add_column(u'c2g_courses', 'meeting_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.listing_description'
        db.add_column(u'c2g_courses', 'listing_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.mode'
        db.add_column(u'c2g_courses', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.join_password'
        db.add_column(u'c2g_courses', 'join_password',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.staff_emails'
        db.add_column(u'c2g_courses', 'staff_emails',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Course.syllabus'
        db.delete_column(u'c2g_courses', 'syllabus')
