...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoToExercise.video_time'
        db.add_column(u'c2g_video_to_exercise', 'video_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoToExercise.video_time'
        db.delete_column(u'c2g_video_to_exercise', 'video_time')
