...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'c2g_problems', (
            ...
            ('problem_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ProblemSet'])),
            ('problem_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'c2g.problemactivity': {
            ...
            'topic_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c2g.VideoTopic']"}),
