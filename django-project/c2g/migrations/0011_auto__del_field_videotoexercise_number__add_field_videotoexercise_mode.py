...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoToExercise.number'
        db.delete_column(u'c2g_video_to_exercise', 'number')

        # Adding field 'VideoToExercise.mode'
        db.add_column(u'c2g_video_to_exercise', 'mode',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoToExercise.mode'
        db.delete_column(u'c2g_video_to_exercise', 'mode')
