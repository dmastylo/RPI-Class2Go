...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'c2g_video_activity', (
            ...
            ('video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Video'], null=True)),
            ('start_seconds', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('c2g', ['VideoActivity'])

        # Deleting field 'Video.start_seconds'
        db.delete_column(u'c2g_videos', 'start_seconds')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Video.start_seconds'
        db.add_column(u'c2g_videos', 'start_seconds',
    ...
    models = {
        ...
        'c2g.videoactivity': {
            ...
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'video_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c2g.Video']", 'null': 'True'})
        },
        'c2g.videoannotation': {
