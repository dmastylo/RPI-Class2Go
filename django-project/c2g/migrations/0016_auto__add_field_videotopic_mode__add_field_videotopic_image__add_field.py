...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoTopic.mode'
        db.add_column(u'c2g_video_topics', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'VideoTopic.image'
        db.add_column(u'c2g_video_topics', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['c2g.VideoTopic']),
                      keep_default=False)

        # Adding field 'VideoTopic.live_datetime'
        db.add_column(u'c2g_video_topics', 'live_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoTopic.mode'
        db.delete_column(u'c2g_video_topics', 'mode')

        # Deleting field 'VideoTopic.image'
        db.delete_column(u'c2g_video_topics', 'image_id')

        # Deleting field 'VideoTopic.live_datetime'
        db.delete_column(u'c2g_video_topics', 'live_datetime')
