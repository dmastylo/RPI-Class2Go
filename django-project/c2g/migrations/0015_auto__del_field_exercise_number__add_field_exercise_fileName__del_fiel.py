...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'c2g_exercises', 'number')

        # Adding field 'Exercise.fileName'
        db.add_column(u'c2g_exercises', 'fileName',
        ...
        db.add_column(u'c2g_problems', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Exercise.number'
        db.add_column(u'c2g_exercises', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Exercise.fileName'
        db.delete_column(u'c2g_exercises', 'fileName')
        ...
        db.delete_column(u'c2g_problems', 'slug')
