...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.is_deleted'
        db.alter_column(u'c2g_courses', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ContentSection.is_deleted'
        db.alter_column(u'c2g_content_sections', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Exercise.is_deleted'
        db.alter_column(u'c2g_exercises', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Problem.is_deleted'
        db.alter_column(u'c2g_problems', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Video.is_deleted'
        db.alter_column(u'c2g_videos', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'AdditionalPage.is_deleted'
        db.alter_column(u'c2g_additional_pages', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Announcement.index'
        db.add_column(u'c2g_announcements', 'index',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Announcement.is_deleted'
        db.alter_column(u'c2g_announcements', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'StudentSection.is_deleted'
        db.alter_column(u'c2g_sections', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ProblemSet.is_deleted'
        db.alter_column(u'c2g_problem_sets', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Course.is_deleted'
        db.alter_column(u'c2g_courses', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ContentSection.is_deleted'
        db.alter_column(u'c2g_content_sections', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Exercise.is_deleted'
        db.alter_column(u'c2g_exercises', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Problem.is_deleted'
        db.alter_column(u'c2g_problems', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Video.is_deleted'
        db.alter_column(u'c2g_videos', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AdditionalPage.is_deleted'
        db.alter_column(u'c2g_additional_pages', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'Announcement.index'
        db.delete_column(u'c2g_announcements', 'index')


        # Changing field 'Announcement.is_deleted'
        db.alter_column(u'c2g_announcements', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'StudentSection.is_deleted'
        db.alter_column(u'c2g_sections', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProblemSet.is_deleted'
        db.alter_column(u'c2g_problem_sets', 'is_deleted', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'c2g.problemset': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'submissions_permitted': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
