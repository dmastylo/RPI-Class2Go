...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProblemActivity.user_selection_val'
        db.alter_column(u'c2g_problem_activity', 'user_selection_val', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'ProblemActivity.user_choices'
        db.alter_column(u'c2g_problem_activity', 'user_choices', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
        # Deleting field 'ProblemSet.slug'
        db.delete_column(u'c2g_problem_sets', 'slug')

        # Adding field 'ProblemSet.slug_url'
        db.add_column(u'c2g_problem_sets', 'slug_url',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProblemActivity.user_selection_val'
        db.alter_column(u'c2g_problem_activity', 'user_selection_val', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ProblemActivity.user_choices'
        db.alter_column(u'c2g_problem_activity', 'user_choices', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'ProblemSet.slug'
        db.add_column(u'c2g_problem_sets', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'ProblemSet.slug_url'
        db.delete_column(u'c2g_problem_sets', 'slug_url')
    ...
    models = {
        ...
        'c2g.problemset': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c2g.ContentSection']", 'null': 'True'}),
            'slug_url': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
