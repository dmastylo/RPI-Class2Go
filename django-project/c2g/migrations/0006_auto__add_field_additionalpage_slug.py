...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalPage.slug'
        db.add_column(u'c2g_additional_pages', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalPage.slug'
        db.delete_column(u'c2g_additional_pages', 'slug')
