...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.course_prefix'
        db.add_column(u'c2g_courses', 'course_prefix',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.course_prefix'
        db.delete_column(u'c2g_courses', 'course_prefix')
    ...
    models = {
        ...
        'c2g.course': {
            ...
            'course_prefix': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'db_index': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
