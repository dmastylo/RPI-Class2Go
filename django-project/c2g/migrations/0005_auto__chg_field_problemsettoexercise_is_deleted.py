...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProblemSetToExercise.is_deleted'
        db.alter_column(u'c2g_problemset_to_exercise', 'is_deleted', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'ProblemSetToExercise.is_deleted'
        db.alter_column(u'c2g_problemset_to_exercise', 'is_deleted', self.gf('django.db.models.fields.BooleanField')())
