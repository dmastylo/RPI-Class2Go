...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemSetToExercise.image'
        db.add_column(u'c2g_problemset_to_exercise', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ProblemSetToExercise'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProblemSetToExercise.mode'
        db.add_column(u'c2g_problemset_to_exercise', 'mode',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemSetToExercise.image'
        db.delete_column(u'c2g_problemset_to_exercise', 'image_id')

        # Deleting field 'ProblemSetToExercise.mode'
        db.delete_column(u'c2g_problemset_to_exercise', 'mode')
