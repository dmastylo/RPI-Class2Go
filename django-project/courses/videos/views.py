...
def view(request, course_id, branch_id):
	return render_to_response('videos/view.html', {'course_id': course_id, 'branch_id': branch_id, 'request': request}, context_instance=RequestContext(request))
	
def edit(request, course_id, branch_id):
	return render_to_response('videos/edit.html', {'course_id': course_id, 'branch_id': branch_id, 'request': request}, context_instance=RequestContext(request))