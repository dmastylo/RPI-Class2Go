...
def overview(request, course_prefix, course_suffix):
    try:
        ...
        raise Http404
    return render_to_response('courses/overview.html', {'course_prefix': course_prefix, 'course_suffix': course_suffix, 'course': course, 'request': request}, context_instance=RequestContext(request))
