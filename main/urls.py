...
urlpatterns = patterns('',
    ...
    url(r'^(?P<course_prefix>[a-zA-Z0-9_-]+)/(?P<course_suffix>[a-zA-Z0-9_-]+)/invideo/(?P<exam_slug>[a-zA-Z0-9_-]+)/feedback', 'courses.exams.views.invideo_feedback',),  # no dollar sign for query param
