...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.preview_only_mode'
        db.add_column(u'c2g_courses', 'preview_only_mode',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.preview_only_mode'
        db.delete_column(u'c2g_courses', 'preview_only_mode')
