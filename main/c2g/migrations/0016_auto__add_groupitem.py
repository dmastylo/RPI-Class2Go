...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'c2g_group_items', (
        ...
        db.send_create_signal('c2g', ['GroupItem'])


    def backwards(self, orm):
        # Deleting model 'GroupItem'
        db.delete_table(u'c2g_group_items')
    ...
    models = {
        ...
        'c2g.groupitem': {
            'Meta': {'object_name': 'GroupItem', 'db_table': "u'c2g_group_items'"},
