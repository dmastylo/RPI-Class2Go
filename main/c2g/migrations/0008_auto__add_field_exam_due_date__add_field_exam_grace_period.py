...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.due_date'
        db.add_column('c2g_exam', 'due_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exam.grace_period'
        db.add_column('c2g_exam', 'grace_period',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.due_date'
        db.delete_column('c2g_exam', 'due_date')

        # Deleting field 'Exam.grace_period'
        db.delete_column('c2g_exam', 'grace_period')
