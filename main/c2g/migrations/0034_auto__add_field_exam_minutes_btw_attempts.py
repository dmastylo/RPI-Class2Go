...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.minutes_btw_attempts'
        db.add_column('c2g_exam', 'minutes_btw_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.minutes_btw_attempts'
        db.delete_column('c2g_exam', 'minutes_btw_attempts')
