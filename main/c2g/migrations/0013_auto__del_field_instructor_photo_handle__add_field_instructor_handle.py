...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Instructor.photo_handle'
        db.delete_column('c2g_instructor', 'photo_handle')

        # Adding field 'Instructor.handle'
        db.add_column(u'c2g_instructor', 'handle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Instructor.photo_handle'
        db.add_column('c2g_instructor', 'photo_handle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Instructor.handle'
        db.delete_column(u'c2g_instructor', 'handle')
