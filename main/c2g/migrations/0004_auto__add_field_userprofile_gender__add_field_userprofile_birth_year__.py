...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'c2g_user_profiles', 'gender')

        # Deleting field 'UserProfile.birth_year'
        db.delete_column(u'c2g_user_profiles', 'birth_year')

        # Deleting field 'UserProfile.education'
        db.delete_column(u'c2g_user_profiles', 'education')
