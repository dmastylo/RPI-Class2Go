...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExamRecord.score'
        db.alter_column('c2g_examrecord', 'score', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding field 'ExamRecordScoreFieldChoice.correct'
        db.add_column('c2g_examrecordscorefieldchoice', 'correct',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'ExamRecordScoreField.subscore'
        db.alter_column('c2g_examrecordscorefield', 'subscore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ExamRecordScore.raw_score'
        db.alter_column('c2g_examrecordscore', 'raw_score', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExamRecord.score'
        db.alter_column('c2g_examrecord', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'ExamRecordScoreFieldChoice.correct'
        db.delete_column('c2g_examrecordscorefieldchoice', 'correct')


        # Changing field 'ExamRecordScoreField.subscore'
        db.alter_column('c2g_examrecordscorefield', 'subscore', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ExamRecordScore.raw_score'
        db.alter_column('c2g_examrecordscore', 'raw_score', self.gf('django.db.models.fields.IntegerField')(null=True))
