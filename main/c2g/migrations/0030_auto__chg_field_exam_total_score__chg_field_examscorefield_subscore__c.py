...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exam.total_score'
        db.alter_column('c2g_exam', 'total_score', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ExamScoreField.subscore'
        db.alter_column('c2g_examscorefield', 'subscore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ExamScore.score'
        db.alter_column('c2g_examscore', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Exam.total_score'
        db.alter_column('c2g_exam', 'total_score', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ExamScoreField.subscore'
        db.alter_column('c2g_examscorefield', 'subscore', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ExamScore.score'
        db.alter_column('c2g_examscore', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))
