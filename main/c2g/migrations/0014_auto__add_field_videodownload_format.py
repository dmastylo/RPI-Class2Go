...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoDownload.format'
        db.add_column(u'c2g_video_download', 'format',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoDownload.format'
        db.delete_column(u'c2g_video_download', 'format')
