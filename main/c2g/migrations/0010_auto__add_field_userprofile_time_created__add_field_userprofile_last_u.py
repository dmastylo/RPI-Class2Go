...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.time_created'
        db.add_column(u'c2g_user_profiles', 'time_created',
        ...
        db.add_column(u'c2g_user_profiles', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2012, 9, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.time_created'
        db.delete_column(u'c2g_user_profiles', 'time_created')

        # Deleting field 'UserProfile.last_updated'
        db.delete_column(u'c2g_user_profiles', 'last_updated')
