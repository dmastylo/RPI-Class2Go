...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentSection.subtitle'
        db.add_column(u'c2g_content_sections', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContentSection.slug'
        db.add_column(u'c2g_content_sections', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentSection.subtitle'
        db.delete_column(u'c2g_content_sections', 'subtitle')

        # Deleting field 'ContentSection.slug'
        db.delete_column(u'c2g_content_sections', 'slug')
