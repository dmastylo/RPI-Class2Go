...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.exam'
        db.add_column(u'c2g_videos', 'exam',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Exam'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.exam'
        db.delete_column(u'c2g_videos', 'exam_id')
