...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExamRecordScoreField.value'
        db.add_column('c2g_examrecordscorefield', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExamRecordScoreField.correct'
        db.add_column('c2g_examrecordscorefield', 'correct',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExamScoreField.value'
        db.add_column('c2g_examscorefield', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExamScoreField.correct'
        db.add_column('c2g_examscorefield', 'correct',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExamRecordScoreField.value'
        db.delete_column('c2g_examrecordscorefield', 'value')

        # Deleting field 'ExamRecordScoreField.correct'
        db.delete_column('c2g_examrecordscorefield', 'correct')

        # Deleting field 'ExamScoreField.value'
        db.delete_column('c2g_examscorefield', 'value')

        # Deleting field 'ExamScoreField.correct'
        db.delete_column('c2g_examscorefield', 'correct')
