...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentGroup.display_style'
        db.alter_column(u'c2g_content_group', 'display_style', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'ContentGroup.display_style'
        db.alter_column(u'c2g_content_group', 'display_style', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
