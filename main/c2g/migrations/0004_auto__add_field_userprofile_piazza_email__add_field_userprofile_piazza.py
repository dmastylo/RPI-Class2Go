...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.piazza_email'
        db.add_column(u'c2g_user_profiles', 'piazza_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.piazza_name'
        db.add_column(u'c2g_user_profiles', 'piazza_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.piazza_email'
        db.delete_column(u'c2g_user_profiles', 'piazza_email')

        # Deleting field 'UserProfile.piazza_name'
        db.delete_column(u'c2g_user_profiles', 'piazza_name')
