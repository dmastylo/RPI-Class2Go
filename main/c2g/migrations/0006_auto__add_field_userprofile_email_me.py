...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.email_me'
        db.add_column(u'c2g_user_profiles', 'email_me',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email_me'
        db.delete_column(u'c2g_user_profiles', 'email_me')
