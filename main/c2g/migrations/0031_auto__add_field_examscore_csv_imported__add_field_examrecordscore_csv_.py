...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExamScore.csv_imported'
        db.add_column('c2g_examscore', 'csv_imported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ExamRecordScore.csv_imported'
        db.add_column('c2g_examrecordscore', 'csv_imported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExamScore.csv_imported'
        db.delete_column('c2g_examscore', 'csv_imported')

        # Deleting field 'ExamRecordScore.csv_imported'
        db.delete_column('c2g_examrecordscore', 'csv_imported')
