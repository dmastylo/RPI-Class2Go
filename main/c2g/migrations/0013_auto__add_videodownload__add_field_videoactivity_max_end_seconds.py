...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoActivity.max_end_seconds'
        db.add_column(u'c2g_video_activity', 'max_end_seconds',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoActivity.max_end_seconds'
        db.delete_column(u'c2g_video_activity', 'max_end_seconds')
