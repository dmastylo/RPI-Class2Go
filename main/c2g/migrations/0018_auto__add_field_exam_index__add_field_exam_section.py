...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.index'
        db.add_column('c2g_exam', 'index',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exam.section'
        db.add_column('c2g_exam', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.ContentSection'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.index'
        db.delete_column('c2g_exam', 'index')

        # Deleting field 'Exam.section'
        db.delete_column('c2g_exam', 'section_id')
