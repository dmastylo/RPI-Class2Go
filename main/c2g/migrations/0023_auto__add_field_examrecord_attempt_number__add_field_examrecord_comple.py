...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExamRecord.attempt_number'
        db.add_column('c2g_examrecord', 'attempt_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExamRecord.complete'
        db.add_column('c2g_examrecord', 'complete',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExamRecord.late'
        db.add_column('c2g_examrecord', 'late',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('c2g_examrecord', 'attempt_number')

        # Deleting field 'ExamRecord.complete'
        db.delete_column('c2g_examrecord', 'complete')
