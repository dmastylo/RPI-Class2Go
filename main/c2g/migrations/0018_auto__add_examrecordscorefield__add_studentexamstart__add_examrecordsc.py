...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('c2g_examrecordscorefield', (
            ...
            ('subscore', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        # Adding field 'Exam.xml_metadata'
        db.add_column('c2g_exam', 'xml_metadata',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Exam.display_single'
        db.add_column('c2g_exam', 'display_single',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'ExamScoreField.comments'
        db.add_column('c2g_examscorefield', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExamScoreField.associated_text'
        db.add_column('c2g_examscorefield', 'associated_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExamScoreField.comments'
        db.delete_column('c2g_examscorefield', 'comments')

        # Deleting field 'ExamScoreField.associated_text'
        db.delete_column('c2g_examscorefield', 'associated_text')
