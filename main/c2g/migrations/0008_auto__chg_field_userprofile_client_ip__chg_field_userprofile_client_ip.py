...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.client_ip'
        db.alter_column(u'c2g_user_profiles', 'client_ip', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'UserProfile.client_ip_first'
        db.alter_column(u'c2g_user_profiles', 'client_ip_first', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.client_ip'
        db.alter_column(u'c2g_user_profiles', 'client_ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))

        # Changing field 'UserProfile.client_ip_first'
        db.alter_column(u'c2g_user_profiles', 'client_ip_first', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))
